...
;(function( w, $ ){
	...
	$.fn[ pluginName ] = function(){
		...
		function snapEvent( elem, x ){
			...
			elem.dispatchEvent( new CustomEvent(pluginName + ".snap", { bubbles: true, detail: {activeSlides: activeSlides} }) )
		}
		...
		return this.each(function(){
			...
			function snapStay(){
				...
				if( startSlide === undefined ){
					startSlide = Math.round( currScroll / width * numItems ) || 0;
				}
				if( afterResize ){
...
// vendor - not available as npm modules



// vendor - available on yarn, but customized by us
